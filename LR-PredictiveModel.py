...
# CPU and memory before prediction
cpu_before = process.cpu_percent(interval=None)
memory_before = process.memory_info().rss

# Perform prediction
_ = lr_model.predict(X_test_preprocessed)

# CPU and memory after prediction
cpu_after = process.cpu_percent(interval=None)
memory_after = process.memory_info().rss

# Calculate overhead
cpu_overhead = cpu_after - cpu_before
memory_overhead = (memory_after - memory_before) / (1024 ** 2)  # Convert bytes to MB
