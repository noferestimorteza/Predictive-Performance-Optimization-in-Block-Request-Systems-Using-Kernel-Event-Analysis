...
# Assuming you want to keep all features for now
...
# Step 9: Build the Random Forest Regressor model
rf_model = RandomForestRegressor(n_estimators=100, random_state=42)
rf_model.fit(X_train_preprocessed, y_train.values.ravel())
...
_ = rf_model.predict(X_test_preprocessed)
